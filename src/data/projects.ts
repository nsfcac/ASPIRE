...
export const projects: Project[] = [
  ...
  },
  {
    ...
    skills: ['Linux & C', 'Containers (Docker / Singularity / Apptainer)', 'Slurm', 'Intel RAPL energy metrics', 'Security experimentation'],
  ...
  },
  {
    ...
    phases: [
      {
        ...
        weekEnd: 3,
        title: 'Training and Literature Grounding',
        body: 'Faculty and mentors train students on Linux, C programming, and the NVIDIA GPU, plus Python, natural language processing, and LLMs as needed to begin training the agent. Mentors guide students through the research literature on learning theories and GPU education.',
      },
      {
        label: 'Phase 2',
        weeks: 'Weeks 4–7',
    ...
    skills: ['Linux & C', 'CUDA / GPU abstractions', 'Python & NLP', 'Open-weight LLMs & RAG', 'Learning-theory instrumentation'],
